...
func (p *hashicupsProvider) Configure(ctx context.Context, req provider.ConfigureRequest, resp *provider.ConfigureResponse) {
	...
	// Retrieve provider data from configurarion
	...
	/*
	 If practitioner provided a configutation value for any of the
	...
	*/
	...
	if config.Host.IsUnknown() {
		resp.Diagnostics.AddAttributeError(
			...
			"The provider cannot create the HashiCups API client as there is an unknown congiguration value for the HashiCups API host. "+
				"Either target apply the source of the value first, set the value statically in the configuration, or use the HASHICUPS_HOST enviroment variable.",
		)
	}
	...
	*/
	...
	/*
	 If any of the expected congigurations are missing,
	 return errors with provider-specific guidance.
	*/
	...
	// create a new HashiCups client using the configuration value
